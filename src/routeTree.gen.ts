...
import { Route as ApiVerifyKeyRouteImport } from './routes/api/verify-key'
...
const ApiVerifyKeyRoute = ApiVerifyKeyRouteImport.update({
  id: '/api/verify-key',
  path: '/api/verify-key',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/api/verify-key': typeof ApiVerifyKeyRoute
...
export interface RootRouteChildren {
  ...
  ApiVerifyKeyRoute: typeof ApiVerifyKeyRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/api/verify-key': {
      id: '/api/verify-key'
      path: '/api/verify-key'
      fullPath: '/api/verify-key'
      preLoaderRoute: typeof ApiVerifyKeyRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/api/video': {
      id: '/api/video'
...
const rootRouteChildren: RootRouteChildren = {
  ...
  ApiVerifyKeyRoute: ApiVerifyKeyRoute,
